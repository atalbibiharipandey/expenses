...
import 'package:expance/core/widgets/curved-bottom-bar/nav_custom_painter.dart';

typedef LetIndexPage = bool Function(int value);

int _currentIndex = 0;

StateSetter? curvedStateSetter;

Function(int? index)? refreshCurvedNavigationBar;
...
class CurvedNavigationBarState extends State<CurvedNavigationBar>
  ...
  late int _length;
  Color shadowColor = cgrey300;

  @override
  void initState() {
    super.initState();
    refreshCurvedNavigationBar = refresh;
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: fs12,
                      color: widget.buttonLabelColor ?? widget.backgroundColor,
